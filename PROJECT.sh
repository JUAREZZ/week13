...
#How to Install Mediawiki for Ubuntu and How to Install LAMP
...
#Here is what I gathered from both resources above to install mediawiki. Installing LAMP Step 1: Update Ubuntu
...
#Mariadb Step 3: Install Mariadb

L#et's install Mariadb and then check to see if it is active
...
#MediaWiki Step 5: Installing Mediawiki
